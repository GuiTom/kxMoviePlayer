...
task :build_movie_debug do
	...
	system_or_exit "lipo -create -arch arm64 tmp/build/Debug-iphoneos/libkxmovie_arm64.a -arch i386 tmp/build/Debug-iphonesimulator/libkxmovie.a -output tmp/build/libkxmovie.a"
end
